...
<html>
  <head>
    <meta charset="utf-8">
    <title>APP Clanberserk - Clans Updates</title>
      ...
      <div class="grid">
        <nav class="navigation">
          ...
          <ul class="navigation__list parent">
            ...
            <li class="navigation__item child"><a class="element is-active" style="cursor: pointer;" onclick="gotourl('clans_updates.php')">Изменения в кланах</a></li>
